...
f_num =   54 #input("Введите число которое ищите ") #ВВедите число которое ближайшее в списке
...
# --------------------------работ но лист нужно set() если добавить два одинаковых числа будет пццц
